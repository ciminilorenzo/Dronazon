...
public class GreetingServiceImplementation extends ChattingGrpc.ChattingImplBase
{
    ...
    {
        System.out.println("\t[DRONE COMMUNICATION MODULE - INPUT] Preparing to answer to a request ");
        ...
        System.out.println("\t[DRONE COMMUNICATION MODULE - INPUT] Answer successfully sent ");
    }
}
